...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (simulateMintBtn) {
    simulateMintBtn.addEventListener('click', () => {
      ...
      showToast(`⚡ Simulation Success: Minted ERC-3643 tokens for ${cls}!`);
    });
  }
  ...
  document.getElementById('downloadPdfBtn')?.addEventListener('click', () => {
    showToast('📄 Download Started: PANGEA_Whitepaper_v2.4.pdf');
  });

  document.getElementById('newsletterForm')?.addEventListener('submit', (e) => {
    e.preventDefault();
    showToast('✨ Thank you for subscribing to PANGEA updates!');
  });
